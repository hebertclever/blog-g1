                            ...
                            <li key={post.id} className='mb-6'>
                                <Link href={`/${post.id}`}>
                                    <div className='flex items-center mb-2'>
                                        ...
                                        <div>
                                            <p className='text-gray-400 mb-2 font-semibold ml-6'>{formatDateUS(post.created_at)}</p>
                                            <h3 className='font-urbanist text-xl font-bold leading-relaxed mb-2 ml-6'>{post.title}</h3>
