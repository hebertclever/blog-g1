...
const Footer = () => {
  return (
    <footer className="border-t-2 border-[#F2F4FC] px-[20px] max-w-[1100px] mx-[auto]">
      <div className="md:flex py-[15px] md:items-center md:justify-between md:border-b">
        <Link href="/">
          <img
      ...
      <div className="md:flex md: items-center justify-between md:mt-[10px] md:flex-row-reverse">
        <div className="flex gap-[20px] items-center w-[133.96px] mx-[auto] justify-between md:mx-[0]">
          <Link href="#">
            <svg
              width="10"
              height="20"
          ...
          <Link href="#">
            ...
            >
              ...
              <path
                ...
                fill="#808D9E"
              />
              <circle cx="17.8745" cy="5.08834" r="0.732875" fill="#808D9E" />
            </svg>
          </Link>
        </div>
        <p className="text-center mt-[20px] text-[#808D9E] text-[16px]">
          ©2022 - Blog
        </p>
      </div>
    </footer>
